...
namespace carl::DynamicTimeWarping
{
    ...
    // (the distance divided by the sequence length) or else the algorithm will simply find the
    // shortest image, not the best, since every additional element introduces a nonnegative absolute 
    // distance.
